...
CREATE TABLE `cart_details` (
  ...
  KEY `cart_details_product_option_id_foreign` (`product_option_id`),
  CONSTRAINT `cart_details_cart_id_foreign` FOREIGN KEY (`cart_id`) REFERENCES `carts` (`id`),
  CONSTRAINT `cart_details_product_option_id_foreign` FOREIGN KEY (`product_option_id`) REFERENCES `product_options` (`id`)
