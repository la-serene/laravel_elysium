...
<html lang="en">
  ...
  <body class="homepage">
    ...
    <nav
      class="navbar navbar-expand-lg navbar-light bg-light text-uppercase fs-6 p-3 border-bottom align-items-center"
    >
        ...
        <div class="row justify-content-between w-100">
          ...
          <div class="col-auto">
            ...
            >
              ...
              <div class="offcanvas-body">
                <ul
                  class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3"
                >
                  <li class="nav-item dropdown">
                    ...
                    >
                      ...
                      <li>
                        <a href="home3.html" class="dropdown-item item-anchor"
                          >Home Layout 3</a
                        >
                      </li>
                      <li>
                        <a href="home4.html" class="dropdown-item item-anchor"
                          >Home Layout 4</a
                        >
                      </li>
                    </ul>
                  ...
                  <li class="nav-item dropdown">
                    ...
                    >
                      ...
                      <li>
                        <a
                          href="shop-three-column-wide.html"
                          class="dropdown-item item-anchor"
                          >Shop Three Column Wide</a
                        >
                      </li>
                      <li>
                        <a
                      ...
                      <li>
                        <a
                          href="shop-four-column-wide.html"
                          class="dropdown-item item-anchor"
                          >Shop Four Column Wide</a
                        >
                      </li>
                      <li>
                        <a
                          href="shop-six-column.html"
                          class="dropdown-item item-anchor"
                          >Shop Six Column</a
                        >
                      </li>
                      <li>
                        <a
                          href="shop-six-column-wide.html"
                          class="dropdown-item item-anchor"
                          >Shop Six Column Wide</a
                        >
                      </li>
                      <li>
                        <a
                  ...
                  <li class="nav-item dropdown">
                    ...
                    >
                      ...
                      <li>
                        <a
                          href="single-post-no-sidebar.html"
                          class="dropdown-item item-anchor"
                  ...
                  <li class="nav-item dropdown">
                    ...
                    >
                      <li>
                        <a href="about.html" class="dropdown-item item-anchor"
                          >About</a
                        >
                      </li>
                      <li>
    ...
    <!-- <section id="billboard" class="bg-light py-5">
      <div class="container">
        <div class="row">
          <h1
            class="section-title text-center my-5"
            data-aos="fade-up"
            data-aos-delay="300"
          >
            New Collections
                ...
                <div class="banner-item image-zoom-effect">
                  ...
                  <div class="banner-content py-4">
                    <h5 class="element-title text-uppercase">
                      <a href="single-product.html" class="item-anchor"
                        >Out crop sweater</a
                      >
                    </h5>
                    <p>
            ...
            <article class="post-item">
              ...
              <div class="post-content d-flex flex-wrap gap-2 my-3">
                ...
                <h5 class="post-title text-uppercase">
                  <a href="single-post.blade.php"
                    >How to look outstanding in pastel</a
                  >
                </h5>
                <p>
                  Dignissim lacus,turpis ut suspendisse vel tellus.Turpis
          ...
          <div class="col-md-4">
            <article class="post-item">
              ...
              <div class="post-content d-flex flex-wrap gap-2 my-3">
                ...
                <h5 class="post-title text-uppercase">
                  <a href="single-post.blade.php"
                    >Crazy fashion with unique moment</a
                  >
                </h5>
                <p>
                  Turpis purus, gravida orci, fringilla dignissim lacus, turpis
        ...
        <div class="row g-3">
          ...
          <div class="col-6 col-sm-4 col-md-2">
            <div class="insta-item">
              <a
                href="https://www.instagram.com/templatesjungle.design/"
                target="_blank"
              >
                <img
        ...
        <div class="row d-flex flex-wrap justify-content-between py-5">
          ...
          <div class="col-md-3 col-sm-6">
            <div class="footer-menu footer-menu-002">
              <h5 class="widget-title text-uppercase mb-4 hehe">Quick Links</h5>
              <ul
          ...
          <div class="col-md-3 col-sm-6">
            <div class="footer-menu footer-menu-003">
              <h5 class="widget-title text-uppercase mb-4 hehe">Help & Info</h5>
              <ul
                class="menu-list list-unstyled text-uppercase border-animation-left fs-6"
              >
                <li class="menu-item">
          ...
          <div class="col-md-3 col-sm-6">
            <div class="footer-menu footer-menu-004 border-animation-left">
              <h5 class="widget-title text-uppercase mb-4 hehe">Contact Us</h5>
              <p class="hehe">
