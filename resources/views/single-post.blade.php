...
<body class="homepage">
  ...
  <section class="hero-section mt-5 py-5">
    <div class="hero-content">
      <div class="container">
        <div class="row text-center">
          <div class="post-meta text-uppercase my-3">
            <span class="post-category">Fashion</span> / <span class="meta-date">12 jan, 2022</span>
          </div>
          <h1 class="post-title text-uppercase">
            <a href="single-post.html">How to look outstanding in pastel colour dress</a>
          </h1>
      ...
      <div class="row g-5">
          ...
          <div class="row">
            <article class="post-item">
              <div class="hero-image">
                <img src="images/post-large-image1.jpg" alt="single-post" class="img-fluid">
              </div>
              <div class="post-content py-5">
                <div class="post-description">
                  ...
                  <img src="images/single-image3.jpg" alt="post-image" class="align-left">
                ...
                <div id="single-post-navigation">
                  <div class="post-navigation d-flex justify-content-between">
                    <a itemprop="url" class="post-prev" href="">
                      ...
                      <span class="page-nav-title text-uppercase">Top 10 fashion trend for summer</span>
                    </a>
                    <a itemprop="url" class="post-next" href="">
                      <i class="icon icon-arrow-right"></i>
                      <span class="page-nav-title text-uppercase">Crazy fashion with unique moment</span>
                    </a>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-9">
                  <div class="post-author-content">
                    <div class="element-title text-uppercase">
                      <a itemprop="url" href="">Anna Younes</a>
                    </div>
                    <span class="author-position">Fashion designer</span>
                    <p>Nascetur libero elementum adipiscing mauris maecenas et magna. Etiam nec, rutrum a diam lacus, nunc integer etiam. Mattis pulvinar non viverra donec pellentesque. Odio mi consequat libero dolor. Porta ut diam lobortis eget leo, lectus. Tortor diam dignissim amet, in interdum aliquet. Magnis dictum et eros purus fermentum, massa ullamcorper sit sollicitudin.</p>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="comments-wrap">
                    ...
                    <div class="comment-list">
                      <article class="comment-item pb-3 row">
                        <div class="col-md-2">
                          <img src="images/commentor-item1.jpg" alt="default" class="commentor-image rounded-circle">
                        </div>
                        <div class="col-md-10">
                          <div class="author-post">
                            <div class="comment-meta text-uppercase d-flex gap-3">
                              <div class="author-name">Lufy carlson</div>
                      ...
                      <article class="comment-item pb-3 row child-comments">
                        <div class="col-md-2">
                          <img src="images/commentor-item2.jpg" alt="default" class="commentor-image rounded-circle">
                        </div>
                        <div class="col-md-10">
                          <div class="author-post">
                            <div class="comment-meta text-uppercase d-flex gap-3">
                              <div class="author-name">Lora leigh</div>
                              <span class="meta-date">Jul 10</span>
                            </div>
                            <p>Tristique tempis condimentum diam done ullancomroer sit element henddg sit he consequert.Tristique tempis condimentum diam done ullancomroer sit element henddg sit he consequert.</p>
                            <div class="comments-reply border-animation">
                      ...
                      <article class="comment-item pb-3 row">
                        <div class="col-md-2">
                          <img src="images/commentor-item3.jpg" alt="default" class="commentor-image rounded-circle">
                        </div>
                        <div class="col-md-10">
                          <div class="author-post">
                            <div class="comment-meta text-uppercase d-flex gap-3">
                              <div class="author-name">Natalie dormer</div>
                              <span class="meta-date">Jul 10</span>
                            </div>
                            <p>Tristique tempis condimentum diam done ullancomroer sit element henddg sit he consequert.Tristique tempis condimentum diam done ullancomroer sit element henddg sit he consequert.</p>
                            <div class="comments-reply border-animation">
        ...
        <aside class="col-md-3">
          <div class="post-sidebar">
            <form role="search" method="get" action="" class="mb-5">
              <div class="wp-block-search d-flex border p-2">
                <input type="search" class="form-control border-0 focus-ring-light" name="s" value="" placeholder="Search" required="">
                <button type="submit" class="border-0 bg-transparent"><i class="icon icon-search"></i></button>
              </div>
            </form>
            <div class="widget sidebar-categories border-animation-left mb-5">
              ...
              <ul class="list-unstyled">
                ...
                <li>
                  <a href="#" class="item-anchor">Fashion</a>
                </li>
                <li>
                  <a href="#" class="item-anchor">Dressup</a>
                </li>
                <li>
                  <a href="#" class="item-anchor">Makeup</a>
                </li>
                <li>
                  <a href="#" class="item-anchor">Photography</a>
                </li>
              </ul>
            </div>
            <div class="widget block-tag mb-5">
              ...
              <ul class="list-unstyled d-flex flex-wrap gap-2">
                <li>
                  <a href="#" class="btn btn-outline-secondary">Beauty</a>
                </li>
                <li>
                  <a href="#" class="btn btn-outline-secondary">Fashion</a>
                </li>
                <li>
                  <a href="#" class="btn btn-outline-secondary">Travel</a>
                </li>
                <li>
                  <a href="#" class="btn btn-outline-secondary">Denim</a>
                </li>
                <li>
                  <a href="#" class="btn btn-outline-secondary">Trending</a>
                </li>
                <li>
                  <a href="#" class="btn btn-outline-secondary">Clothing</a>
                </li>
                <li>
                  <a href="#" class="btn btn-outline-secondary">Photography</a>
                </li>
                <li>
                  <a href="#" class="btn btn-outline-secondary">Jackets</a>
                </li>
              </ul>
            </div>
                  ...
                  <div class="col-md-8">
                    <div class="sidebar-post-content text-uppercase">
                      <div class="post-meta fs-6 text-secondary">
                        <span class="meta-date">jul 11, 2022</span>
                      </div>
                      <h6 class="post-title">
              ...
              <div class="sidebar-post-item d-flex justify-content-center">
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <div class="sidebar-post-content text-uppercase">
                      <div class="post-meta fs-6 text-secondary">
                        <span class="meta-date">jul 18, 2022</span>
                      </div>
                      <h6 class="post-title">
                        <a href="#">Top 10 minimal outlooks for womens</a>
                      </h6>
                    </div>
                  </div>
                </div>
              ...
              <div class="sidebar-post-item d-flex justify-content-center">
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <div class="sidebar-post-content text-uppercase">
                      <div class="post-meta fs-6 text-secondary">
                        <span class="meta-date">Aug 21, 2022</span>
                      </div>
                      <h6 class="post-title">
                        <a href="#">Soft cotton onepiece dress for women</a>
                      </h6>
                    </div>
                  </div>
                </div>
  ...
  <section class="related-post post-wrap py-4">
    <div class="container">
      <div class="section-header d-flex align-items-center justify-content-between">
        <h2 class="section-title text-uppercase">Related Posts</h2>
      </div>
      <div class="row">
        <div class="col-md-4">
          <article class="post-item">
            <div class="post-image">
              <a href="single-post.html"><img src="images/post-image1.jpg" alt="image" class="post-grid-image img-fluid"></a>
            </div>
        ...
        <div class="col-md-4">
          <article class="post-item">
            <div class="post-image">
              <a href="single-post.html"><img src="images/post-image2.jpg" alt="image" class="post-grid-image img-fluid"></a>
            </div>
            <div class="post-content">
              <div class="post-meta text-uppercase">
                <span class="post-category">Fashion /</span>
        ...
        <div class="col-md-4">
          <article class="post-item">
            <div class="post-image">
              <a href="single-post.html"><img src="images/post-image3.jpg" alt="image" class="post-grid-image img-fluid"></a>
            </div>
            <div class="post-content">
              <div class="post-meta text-uppercase">
                <span class="post-category">Fashion /</span>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 text-end">
            <p>© Copyright 2022 Kaira. All rights reserved. Design by <a href="https://templatesjungle.com" target="_blank">TemplatesJungle</a></p>
          </div>
        </div>
      </div>
    </div>
