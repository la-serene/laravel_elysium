...
<body class="homepage">
  ...
  <section id="billboard" class="bg-light py-5">
    <div class="container">
      <div class="row">
        <h1 class="section-title text-center my-5" data-aos="fade-up" data-aos-delay="300">New Collections</h1>
          ...
          <div class="swiper-wrapper d-flex border-animation-left">
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="images/banner-image1.jpg" alt="product" class="img-fluid">
                  </a>
                </div>
            ...
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="images/banner-image2.jpg" alt="product" class="img-fluid">
                  </a>
                </div>
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
            ...
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="images/banner-image3.jpg" alt="product" class="img-fluid">
                  </a>
                </div>
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
        ...
        <div class="icon-arrow icon-arrow-left"><svg width="50" height="50" viewBox="0 0 24 24"><use xlink:href="#arrow-left"></use></svg></div>
      ...
      <div class="row">
        ...
        <div class="collection-item d-flex flex-wrap my-5">
          <div class="col-md-6 column-container">
            <div class="image-holder">
              <img src="images/single-image.jpg" alt="collection" class="product-image img-fluid">
            </div>
          </div>
          <div class="col-md-6 column-container bg-white">
            <div class="collection-content p-5 m-0 m-md-5">
              ...
              <a href="#" class="btn btn-dark text-uppercase">Shop Collection</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="swiper-wrapper d-flex">
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                <a href="single-product.html">
                  <img src="images/product-item5.jpg" alt="product" class="product-image img-fluid">
                </a>
                <a href="wishlist.html" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24"><use xlink:href="#heart"></use></svg>
                </a>
          ...
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                <a href="single-product.html">
                  <img src="images/product-item6.jpg" alt="product" class="product-image img-fluid">
                </a>
                <a href="wishlist.html" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24"><use xlink:href="#heart"></use></svg>
                </a>
          ...
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                <a href="single-product.html">
                  <img src="images/product-item7.jpg" alt="product" class="product-image img-fluid">
                </a>
                <a href="wishlist.html" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24"><use xlink:href="#heart"></use></svg>
                </a>
          ...
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                <a href="single-product.html">
                  <img src="images/product-item8.jpg" alt="product" class="product-image img-fluid">
                </a>
                <a href="wishlist.html" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24"><use xlink:href="#heart"></use></svg>
                </a>
          ...
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                <a href="single-product.html">
                  <img src="images/product-item11.jpg" alt="product" class="product-image img-fluid">
                </a>
                <a href="wishlist.html" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24"><use xlink:href="#heart"></use></svg>
                </a>
...
<?php /**PATH J:\workspace\laragon\www\laravel_elysium\resources\views/index.blade.php ENDPATH**/ ?>